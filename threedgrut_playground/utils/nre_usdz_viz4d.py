...
timeline + ftheta intrinsics + ``world_to_nre``; coordinate offsets are a
measured no-op — static gaussians already share the rig/track NuRec space and
dynamic_rigids are object-local). The result is a ckpt dict that:
