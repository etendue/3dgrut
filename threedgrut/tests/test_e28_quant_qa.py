...
def test_summarize_replace_report_counts_by_class_and_fallback():
    report = [
        {"track": "24", "label_class": "automobile", "chosen_asset": "a",
         "fallback_level": 1, "skipped": False},
        {"track": "54", "label_class": "automobile", "chosen_asset": "a",
         "fallback_level": 1, "skipped": False},
        {"track": "405", "label_class": "bus", "chosen_asset": None,
         "fallback_level": 0, "skipped": True},
    ]
...
def test_qa_sanity_and_replace_report_folded_through():
    ...
    report = [{"track": "24", "label_class": "automobile", "chosen_asset": "a",
               "fallback_level": 1, "skipped": False}]
