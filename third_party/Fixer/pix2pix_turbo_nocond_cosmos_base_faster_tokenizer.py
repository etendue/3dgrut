...
from model import (
    make_1step_sched_base as make_1step_sched,  # , my_vae_encoder_fwd, my_vae_decoder_fwd
)
...
class Pix2Pix_Turbo(torch.nn.Module):
    ...
    def initialize_cosmos_model(self):
        ...
        vae = (
            model.tokenizer
        )  # model.tokenizer <projects.cosmos.diffusion.v2.tokenizers.wan2pt1.Wan2pt1VAEInterface object at 0x155401d12c20>
    ...
    def forward(self, x, timesteps=None):
        ...
        model_pred = self.unet.denoise(xt_B_C_T_H_W=unet_input, sigma=sigma_B_T, condition=self.condition).x0
