...
| MC-6 | 非 FTheta distorted pinhole overlay 仍用 browser ideal pinhole | ✅ 已关闭 | P1 | calibrated OpenCVPinhole 已接 `PinholeForwardProjector`；inceptio 5 相机 NCore SDK parity 100% validity agreement + 0.000017–0.000036 px MAE；integer roundtrip verified |
