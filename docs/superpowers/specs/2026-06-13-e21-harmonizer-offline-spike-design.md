...
- **baseline ckpt（待 Task 0 锁定）**：E1.1 三方锚 = baseline / B3(`~/work/output/p31b3_depthoff_30k/...`) / aniso20(`~/work/output/p31aniso20_depthoff_30k/...`)；`~/work/output/` 下多个 `9ae151dc...ckpt_last.pt`，**baseline 具体目录待 Task 0 比对 gap 表数字（lane grad_corr@3m=0.384 / FID@3m=168）确认锁定**。
